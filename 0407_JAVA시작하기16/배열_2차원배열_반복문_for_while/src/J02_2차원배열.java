public class J02_2차원배열 {
    public static void main(String[] args) {
        ...
        String[] arr4 ={"11","22","13","34","56"};//조회수
        ...
        System.out.println("2차원 배열 1행출력=======================");
        System.out.println("arr[0][0] = " + arr[0][0]);
        System.out.println("arr[1][1] = " + arr[0][1]);
        System.out.println("arr[2][2] = " + arr[0][2]);
        System.out.println("arr[3][3] = " + arr[0][3]);
        System.out.println("arr[0][4] = " + arr[0][4]);

        System.out.println("2차원 배열 2열출력=======================");
        ...
        //배열 열 길이 알아내기
        System.out.println( "1행별 열 길이 : " +arr[0].length);
        System.out.println( "2행별 열 길이 : " +arr[1].length);
        System.out.println( "3행별 열 길이 : " +arr[2].length);
        System.out.println( "4행별 열 길이 : " +arr[3].length);
        System.out.println();
        System.out.println();
        System.out.println();
        ...
        for(int i =0; i<arr.length; i++){//4행 0 ~ 3
        ...
        System.out.println();
        System.out.println("2차원 배열처리 게시판 반복문 출력=================");
        ...
        String[][] board={
            ...
            {"5","글제목5","2023-01-05","56"}
        };
        //차원 배열 for문 출력

        for(int i=0; i<board.length; i++){ //5행
            for(int j=0; j<board[i].length; j++){ //4열
